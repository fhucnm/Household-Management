        ...
        <div class="row">
            ...
            <div class="col-md-10 main-content">
                ...
                <div class="welcome-text">
                    <h4>DANH SÁCH THÀNH VIÊN TRONG HỘ KHẨU THƯỜNG TRÚ</h4>
                ...
                <div class="card-custom">
                    ...
                    <div class="mt-3">
                        <form action="citizen?action=tamtru" method="POST">
                            <input type="hidden" name="cccd" value="<%= user.getCccd()%>">
                            <a href="#"><button type="submit" class="btn btn-danger btn-sm">Xem hộ khẩu tạm trú</button></a>
                        </form>
                    </div>
                    
                    <div class="mt-3">
                        <form action="citizen?action=luutrutamthoi" method="POST">

                            <input type="hidden" name="cccd" value="<%= user.getCccd()%>">
                            <a href="#"><button type="submit" class="btn btn-danger btn-sm">Xem hộ khẩu lưu trú tạm thời</button></a>
                        </form>
