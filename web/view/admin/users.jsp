...
<html lang="vi">
    <head>
        ...
        <link rel="stylesheet" href="./css/admin-home-work.css">
            ...
            <div class="row">
                ...
                <div class="col-md-10 main-content">
                    ...
                    <div class="welcome-text">
                        ...
                        <p>Quản lý thông tin công dân trong hệ thống</p>
                    </div>

                    <!-- Search Form -->
                    <form action="admin?action=search" method="POST" class="mb-3">
                        <div class="input-group w-50">
                            <input type="text" name="keywords" class="form-control" placeholder="Tìm kiếm theo từ khóa">
                                ...
                                <c:forEach var="user" items="${listUsers}">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="admin?action=delete" method="POST" style="display:inline;">
        ...
        <script>
                                                    ...
                                                    function showForm() {
                                                        ...
                                                        if (form.style.display === 'none' || form.style.display === '') {
                                                            ...
                                                            form.querySelector('form').action = "admin?action=insert";
                                                    ...
                                                    function editForm(e) {
                                                        ...
                                                        let roleSelect = form.querySelector('select[name="roleId"]');
                                                        for (let option of roleSelect.options) {
                                                            if (option.text.trim() === roleName) {
                                                                option.selected = true;
                                                                break;
                                                            }
                                                        }
                                                        let addressSelect = form.querySelector('select[name="addressId"]');
                                                        for (let option of addressSelect.options) {
                                                            if (option.textContent.trim() === address) {
                                                                option.selected = true;
                                                                break;
                                                            }
                                                        }
                                                        ...
                                                        form.querySelector('form').action = "admin?action=update";
                                                    }
        </script>
    </body>
</html>