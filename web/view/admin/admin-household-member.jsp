        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-10 main-content">
                    ...
                    <div class="mb-3">
                        <form action="admin?action=insertHouseholdMember" method="POST" id="form" style="display: none">
                                            ...
                                            <c:forEach var="m" items="${listHouseholdMember}">
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form action="admin?action=deleteHouseholdMember" method="POST" style="display:inline;">
                    ...
                    <div class="mt-3">
                        <form action="admin?action=changeHeadOfHouseholdCccd" method="POST">
                            <input type="hidden" name="householdId" value="<%= householdId %>">
                    ...
                    <!-- Back Link -->
                    <div class="mt-3">
                        <a href="admin?action=listHouseHold" class="btn btn-secondary">Quay lại danh sách hộ khẩu</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script>
                                                                ...
                                                                function showForm() {
                                                                    ...
                                                                    if (form.style.display === 'none' || form.style.display === '') {
                                                                        ...
                                                                        form.querySelector('form').action = "admin?action=insertHouseholdMember";
                                                                ...
                                                                function editForm(e) {
                                                                    ...
                                                                    form.action = "admin?action=updateHouseholdMember";
                                                                }
        </script>
    </body>
</html>