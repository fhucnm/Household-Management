                        ...
                        <tbody>
                            <c:forEach items="${listRegistrations}" var="reg">
                                <tr>
                                    ...
                                    <td>${reg.addressId}</td>
                                    <td>
                                        <form action="registration?action=accept" style="display:inline" method="POST">
                                            ...
                                            <input type="hidden" name="addressId" value="${reg.addressId}">
                                            <button type="submit" class="btn btn-success btn-sm">Duyệt</button>
                                        </form>
                                        <form action="registration?action=reject" style="display:inline" method="POST">
                                            <input type="hidden" name="registrationId" value="${reg.registrationId}">
                                            <input type="hidden" name="cccd" value="${reg.cccd}">
