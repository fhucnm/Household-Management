...
<head>
    ...
    <link rel="stylesheet" href="./css/official.css"> <!-- Liên kết đến tệp CSS -->
</head>
<body>
    <!-- Header -->
        <div class="header">
        ...
        <div class="row">
            ...
            <div class="col-md-10 main-content">
                ...
                <div class="welcome-text">
                    <h4>Xin chào, trợ lý quản trị viên <%= user.getFullName() %> ở khu vực <%= user.getAddress()%>!</h4>
                ...
                <div class="row row-cols-1 row-cols-md-4 g-4">
                    <div class="col">
                        <div class="card-custom">
                            ...
                            <a href="official?action=listUsers&addressId=<%= user.getAddressId()%>">Xem ngay</a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card-custom">
                            ...
                            <a href="official?action=listRegistrations&addressId=<%= user.getAddressId()%>">Xem ngay</a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card-custom">
                            ...
                            <a href="official?action=listApproved&addressId=<%= user.getAddressId()%>">Xem ngay</a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card-custom">
                            ...
                            <a href="official?action=listRejected&addressId=<%= user.getAddressId()%>">Xem ngay</a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card-custom">
                            ...
                            <a href="official?action=listHouseHold&addressId=<%= user.getAddressId()%>">Xem ngay</a>
                        </div>
                    </div>
