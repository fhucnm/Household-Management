            ...
            <div class="row">
                ...
                <div class="col-md-10 main-content">
                    <div class="profile-container">
                        ...
                        <form action="household?action=transfer" method="POST">

                            <!-- Số CCCD của chủ hộ -->
                            <div class="mb-3">
                                <label for="cccd" class="form-label">Số CCCD Chủ Hộ</label>
                            ...
                            <!-- Địa chỉ muốn chuyển đến -->
                            <div class="mb-3">
                                <% ArrayList<Address> addressList = AddressDAO.findAll(); %>
                                <label for="newAddressId" class="form-label">Địa chỉ muốn chuyển đến</label>
                                <select class="form-control" id="newAddressId" name="newAddressId" required>
                            ...
                            <button type="submit" class="btn-custom">Tạo hộ khẩu</button>
                        </form>
                    </div>
                </div>
            </div>
